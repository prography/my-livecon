...
parser.add_argument('--num_classes', type=int, default=10, help='# of classes in source domain')
...
parser.add_argument('--log_interval', type=int, default=50, help='interval for console display')
