...
class Trainer(object):
    ...
    def build_networks(self):
        ...
        self.netE = vgg13_bn(pretrained=True).features
    ...
    def train(self):
        ...
        print("length of validating dataloader:", len(val_source_iter), len(val_target_iter))
        ...
        for epoch in range(self.num_epochs):
            ...
            while source_idx<len(source_iter) and target_idx<len(target_iter):
                ...
                if self.crossentropy:
                    ...
                    output_h_source = self.netE(x_hat_source)
