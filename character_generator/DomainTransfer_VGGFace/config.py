...
parser.add_argument('--datarootA', default="/home/young/dev/Mentor-Livecon/DomainTransfer_VGGFaceNet/dataset/dataset_cropped/train/A/origin", help='root-path for datasetA')
parser.add_argument('--valDatarootA', default="/home/young/dev/Mentor-Livecon/DomainTransfer_VGGFaceNet/dataset/dataset_cropped/train/A/origin", help='root-path for val. datasetA')

parser.add_argument('--datasetB', default='googleCartoon',  help='dataset name for B domain')
parser.add_argument('--datarootB', default="/home/young/dev/Mentor-Livecon/DomainTransfer_VGGFaceNet/dataset_cartoon", help='root-path for datasetB')
parser.add_argument('--valDatarootB', default="/home/young/dev/Mentor-Livecon/DomainTransfer_VGGFaceNet/dataset_cartoon", help='root-path for val. datasetB')
...
parser.add_argument('--netE', default="/home/young/dev/Mentor-Livecon/DomainTransfer_VGGFaceNet/encoder_weights/vggface.h5", help="path to netE trained on source domain")

parser.add_argument('--mode', type=str, default='train', choices=['train', 'test'], help="main mode")

# Training configurations
parser.add_argument('--num_epochs', type=int, default=10, help='number of epochs to train for')
parser.add_argument('--num_critics', type=int, default=5, help='number of updating Generator per Discriminator')
