...
parser.add_argument('--log_interval', type=int, default=100, help="step interval to print log message")
parser.add_argument('--sample_interval', type=int, default=1, help="epoch interval to save sample images")
